...
public class SpriteAnim : MonoBehaviour {
	...
	public SpriteMove m_Move;
	public SpriteScale m_Scale;
	public SpriteColor m_Tint;
	...
	void Start()
	{
		...
		if(m_Move==null)
			m_Move=GetComponent<SpriteMove>();
		
		if(m_Scale==null)
			m_Scale=GetComponent<SpriteScale>();
		
		if(m_Tint==null)
			m_Tint=GetComponent<SpriteColor>();
	...
	{
			//Sprite
			if(m_Renderer!=null&&m_Library.UseADifferentSprite(_animID,_goalID))
